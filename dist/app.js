...
var t = __webpack_require__(0);function n(t, n) {
  ...
  return "string" == typeof t && (t = t.split(/\s*,\s*/)), function (n) {
    for (var r = {}, e = 0; e < t.length; e++) r[t[e]] = n[t[e]];return r;
  };
}function e(t, n) {
  ...
  return "function" != typeof o && (o = r(o || [])), function (r) {
    function u(u, c) {
      var f = this,
          ...
          a = i ? n(i, s) : { store: s },
          l = function () {
        var t = o(s ? s.getState() : {}, f.props);for (var n in t) if (t[n] !== p[n]) return p = t, f.setState(null);for (var r in p) if (!(r in t)) return p = t, f.setState(null);
